...
export default function AppShell({ children, title, breadcrumbs = [] }) {
    ...
    return (
        <div className="h-screen overflow-hidden bg-slate-50 text-slate-800 flex flex-col font-sans antialiased">
            ...
            <div className="flex flex-1 pt-16 overflow-hidden">
                ...
                <aside
                    className={`fixed lg:sticky lg:top-16 inset-y-0 lg:inset-y-auto left-0 z-20 w-64 h-[calc(100vh-4rem)] bg-[#0F172A] border-r border-slate-800 flex flex-col justify-between transition-transform duration-200 ease-in-out shadow-lg shrink-0 ${
                        mobileMenuOpen
                            ? "translate-x-0 top-16"
                            : "-translate-x-full lg:translate-x-0"
                    }`}
                >
                    {/* Area Navigasi dengan min-h-0 agar overflow-y-auto bekerja sempurna */}
                    <div className="px-3 space-y-6 overflow-y-auto pt-4 flex-1 min-h-0 custom-scrollbar">
                    ...
                    {/* Footer Sidebar */}
                    <div className="p-4 border-t border-slate-800 bg-slate-950/60 text-slate-400 text-center text-[11px] font-medium shrink-0">
